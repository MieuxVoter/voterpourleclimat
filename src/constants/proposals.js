...
export const SE_LOGER = [
  {
    proposal:
      "Contraindre les propriétaires occupants et bailleurs à rénover leurs biens.",
    objectiveId: "sl1",
  },
  {
    proposal:
  ...
  {
    proposal: "Déployer un réseau harmonisé de guichets uniques.",
    objectiveId: "sl1",
  },
  {
    proposal:
      "Créer un système d'aides à la rénovation, avec prêts et subventions pour les plus démunis.",
    objectiveId: "sl1",
  },
  {
    proposal:
  ...
  {
    proposal:
      "Inciter à limiter le recours au chauffage et à la climatisation dans les logements, les espaces publics et ceux ouverts au public ainsi que les bâtiments tertiaire.",
    objectiveId: "sl2",
  },
  {
    proposal:
...
export const SE_DEPLACER = [
  ...
  {
    proposal:
      "Aider les entreprises à mettre en place des plans de mobilité via les Autorités organisatrices de la mobilité (AOM) ",
    objectiveId: "sd8",
  },
  {
    proposal:
...
export const PRODUIRE = [
  ...
  {
    proposal:
      "Annualiser le reporting et l'étendre à toutes les organisations. Imposer une sanction pour manquement aux obligations  en % du chiffre d'affaire",
    objectiveId: "pt5",
  },
  {
    proposal:
  ...
  {
    proposal:
      "Ajustement carbone aux frontières de l’UE (en fonction de l'empreinte carbone des produits) et prise en compte des enjeux de redistribution pour éviter de peser sur les ménages les moins favorisés",
    objectiveId: "pt8",
  },
  {
...
export const CONSTITUTION = [
  ...
  {
    proposal:
      "Renforcement du rôle du Conseil Economique Social et Environnemental",
    objectiveId: "ct1",
  },
]
